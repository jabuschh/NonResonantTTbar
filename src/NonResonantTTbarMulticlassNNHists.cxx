...
NonResonantTTbarMulticlassNNHists::NonResonantTTbarMulticlassNNHists(uhh2::Context& ctx, const std::string& dirname):
Hists(ctx, dirname) {
...
void NonResonantTTbarMulticlassNNHists::init(){
...
void NonResonantTTbarMulticlassNNHists::fill(const Event & event){
...
NonResonantTTbarMulticlassNNHists::~NonResonantTTbarMulticlassNNHists(){}
