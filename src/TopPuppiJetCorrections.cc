...
TopPuppiJetCorrections::TopPuppiJetCorrections(){
  ...
  tpuppijec_tag_UL16preVFP = "Summer19UL16";
  tpuppijec_ver_UL16preVFP = "2";

  tpuppijec_tag_UL16postVFP = "Summer19UL16APV";
  tpuppijec_ver_UL16postVFP = "2";
...
void TopPuppiJetCorrections::init(Context & ctx){
  ...
  if(userTopJetColl.find("puppi") != std::string::npos){
    ...
    std::cout << "TopPuppiJetCorrections.cxx: Cannot determine pileup subtraction (neither CHS nor PUPPI) - going to assume it is CHS for JECs" << std::endl;
  }
  ...
  if(is_mc){
    ...
    if(year == Year::is2016v2 || year == Year::is2016v3){
      ...
      throw runtime_error("TopPuppiJetCorrections.cxx: Cannot find suitable jet resolution file & scale factors for this year for JetResolutionSmearer");
    }
