...
NonResonantTTbarPreselectionHists::NonResonantTTbarPreselectionHists(uhh2::Context& ctx, const std::string& dirname):
Hists(ctx, dirname) {
...
void NonResonantTTbarPreselectionHists::init(){
...
void NonResonantTTbarPreselectionHists::fill(const Event & event){
...
NonResonantTTbarPreselectionHists::~NonResonantTTbarPreselectionHists(){}
