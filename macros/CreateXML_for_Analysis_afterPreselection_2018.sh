...
path_data=/nfs/dust/cms/group/zprime-uhh/Presel_2018/workdir_Zprime_PreSelec_2018/uhh2.AnalysisModuleRunner.

mkdir $pathGL_code/NonResonantTTbar/data/Skimming_datasets_2018
cd $pathGL_code/NonResonantTTbar/data/Skimming_datasets_2018
