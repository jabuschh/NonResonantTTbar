...
class NonResonantTTbarGeneratorHists: public uhh2::Hists {
public:
  explicit NonResonantTTbarGeneratorHists(uhh2::Context&, const std::string&);
...
protected:
  ...
  virtual ~NonResonantTTbarGeneratorHists();
};
