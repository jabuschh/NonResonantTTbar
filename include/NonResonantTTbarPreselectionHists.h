...
class NonResonantTTbarPreselectionHists: public uhh2::Hists {
public:
  explicit NonResonantTTbarPreselectionHists(uhh2::Context&, const std::string&);
...
TH2F *dRmin_ptrel_mu, *dRmin_ptrel_mu1, *dRmin_ptrel_ele, *dRmin_ptrel_ele1;
  ...
  virtual ~NonResonantTTbarPreselectionHists();
};
