{
  ...
  h_ALPinterference->Scale(-1. / (h_ALPinterference->Integral()));
  ...
  double Nevents_h_ttbar   = h_ttbar  ->Integral();
  double Nevents_h_wjets   = h_wjets  ->Integral();
  double Nevents_h_dy      = h_dy     ->Integral();
  double Nevents_h_st      = h_st     ->Integral();
  double Nevents_h_qcd     = h_qcd    ->Integral();
  double Nevents_h_diboson = h_diboson->Integral();
  double Nevents_SMbkg     = Nevents_h_ttbar + Nevents_h_wjets + Nevents_h_dy + Nevents_h_st + Nevents_h_qcd + Nevents_h_diboson;

  h_ttbar  ->Scale(1. / Nevents_SMbkg);
  h_wjets  ->Scale(1. / Nevents_SMbkg);
  h_dy     ->Scale(1. / Nevents_SMbkg);
  h_st     ->Scale(1. / Nevents_SMbkg);
  h_qcd    ->Scale(1. / Nevents_SMbkg);
  h_diboson->Scale(1. / Nevents_SMbkg);
  ...
  if(logyaxis) c1->SaveAs(save_dir + "mttbar" + "_normalized_logscale.pdf");
  else c1->SaveAs(save_dir + "mttbar" + "_normalized.pdf");
  c1->Close();
}
